...
namespace SMS.DAL.Migrations
{
    ...
    [Migration("20240314185237_course_lesson_module_rel")]
    partial class course_lesson_module_rel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseModule", b =>
                {
                    ...
                    b.Property<int>("UsedInCoursesId")
                        .HasColumnType("integer");

                    b.HasKey("ModulesId", "UsedInCoursesId");

                    b.HasIndex("UsedInCoursesId");
            ...
            modelBuilder.Entity("LessonModule", b =>
                {
                    ...
                    b.Property<int>("UsedInModulesId")
                        .HasColumnType("integer");

                    b.HasKey("LessonsId", "UsedInModulesId");

                    b.HasIndex("UsedInModulesId");
            ...
            modelBuilder.Entity("SMS.DAL.Data.Entities.Concrete.Lesson", b =>
                {
                    ...
                    b.Property<int[]>("UsedInModuleIds")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("SMS.DAL.Data.Entities.Concrete.Module", b =>
                {
                    ...
                    b.Property<int[]>("UsedInCourseIds")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("CourseModule", b =>
                {
                    b.HasOne("SMS.DAL.Data.Entities.Concrete.Module", null)
                        .WithMany()
                        .HasForeignKey("ModulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SMS.DAL.Data.Entities.Concrete.Course", null)
                        .WithMany()
                        .HasForeignKey("UsedInCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LessonModule", b =>
                {
                    b.HasOne("SMS.DAL.Data.Entities.Concrete.Lesson", null)
                        .WithMany()
