...
namespace SMS.DAL.Repositories
{
    [Injectible(
        ...
        Implements = typeof(IChatRepository))]
    public class ChatRepository : CoreRepository<Chat, CoreDbContext>, IChatRepository
    {
        public ChatRepository(CoreDbContext context) : base(context)
        {
        }
    }
}
