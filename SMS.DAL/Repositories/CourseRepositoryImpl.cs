...
namespace SMS.DAL.Repositories
{
    [Injectible(
        ...
        Implements = typeof(ICourseRepository))]
    public class CourseRepositoryImpl : CoreRepository<Course, CoreDbContext>, ICourseRepository
    {
        public CourseRepositoryImpl(CoreDbContext context) : base(context) { }
    }
}
